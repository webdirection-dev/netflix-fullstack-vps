...
export const selectUsersInfo = (state: RootState) => ({
    ...
    qty: state.users.users.length,
});

export const selectAllUsers = (state: RootState) => state.users.users;
export const selectUserById = (state: RootState) => state.users.user;
export const selectNewUsers = (state: RootState) => state.users.newUsers;
export const selectStats = (state: RootState) => state.users.stats;
